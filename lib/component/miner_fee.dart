  ...
  Widget _btcFee(BuildContext context, KTransferState provider,
    ...
    return GestureDetector(
      ...
      child: Container(
        margin: EdgeInsets.only(top: 8.width),
        padding:
            EdgeInsets.only(left: 8.width, right: 8.width, bottom: 8.width),
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(4),
          color: Colors.white,
        ),
              ...
              child: Row(
                children: [
                  Text(
                    "payment_slow".local(),
                    style:
                        TextStyle(color: Color(0xFF161D2D), fontSize: 16.font),
                  ),
                  6.rowWidget,
                  Expanded(
                    child: SliderTheme(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Consumer<KTransferState>(builder: (_, provider, child) {
